...
def predict():
	...
	df = web.DataReader(companyname, data_source='yahoo', start='2019-01-01', end='2020-01-01')
	...
	#Get the quote
	company_quote = web.DataReader(companyname, data_source='yahoo', start='2020-01-01', end='2021-01-01')
